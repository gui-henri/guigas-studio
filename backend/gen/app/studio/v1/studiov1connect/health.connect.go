...
const (
	...
	HealthServiceName = "app.studio.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/app.studio.v1.HealthService/Check"
)

// HealthServiceClient is a client for the app.studio.v1.HealthService service.
type HealthServiceClient interface {
	Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error)
}

// NewHealthServiceClient constructs a client for the app.studio.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_app_studio_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls app.studio.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the app.studio.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/app.studio.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app.studio.v1.HealthService.Check is not implemented"))
}
